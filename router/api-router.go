	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invite-code", controller.GetUserInviteCodeDetail)
				selfRoute.PUT("/invite-code", controller.UpdateUserInviteCodeRules)
				selfRoute.POST("/invite-code/refresh", controller.RefreshUserInviteCode)
				selfRoute.GET("/invite-codes/history", controller.ListInviteCodeHistory)
